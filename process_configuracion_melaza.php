...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            $sql = "INSERT INTO cc_melaza (cc_melaza_nombre, cc_melaza_etapa, cc_melaza_racion, cc_melaza_costo, cc_melaza_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE cc_melaza 
                    SET cc_melaza_nombre = :melaza, 
                        cc_melaza_etapa = :etapa,
                        cc_melaza_racion = :racion, 
                        cc_melaza_costo = :costo, 
                        cc_melaza_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM cc_melaza WHERE id = :id";
