...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            $sql = "INSERT INTO cc_sal (cc_sal_nombre, cc_sal_etapa, cc_sal_racion, cc_sal_costo, cc_sal_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE cc_sal 
                    SET cc_sal_nombre = :sal, 
                        cc_sal_etapa = :etapa,
                        cc_sal_racion = :racion, 
                        cc_sal_costo = :costo, 
                        cc_sal_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM cc_sal WHERE id = :id";
