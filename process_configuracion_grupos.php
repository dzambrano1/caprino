...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO cc_grupos (cc_grupos_nombre) VALUES (:grupos)";
        ...
        case 'update':
            ...
            $sql = "UPDATE cc_grupos SET cc_grupos_nombre = :grupos WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM cc_grupos WHERE id = :id";
