...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO cc_clostridiosis (cc_clostridiosis_vacuna, cc_clostridiosis_dosis, cc_clostridiosis_costo, cc_clostridiosis_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE cc_clostridiosis 
                    SET cc_clostridiosis_vacuna = :vacuna, 
                        cc_clostridiosis_dosis = :dosis, 
                        cc_clostridiosis_costo = :costo, 
                        cc_clostridiosis_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM cc_clostridiosis WHERE id = :id";
