...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO cc_cbr (cc_cbr_vacuna, cc_cbr_dosis, cc_cbr_costo, cc_cbr_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE cc_cbr 
                    SET cc_cbr_vacuna = :vacuna, 
                        cc_cbr_dosis = :dosis, 
                        cc_cbr_costo = :costo, 
                        cc_cbr_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM cc_cbr WHERE id = :id";
