...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO cc_brucelosis (cc_brucelosis_vacuna, cc_brucelosis_dosis, cc_brucelosis_costo, cc_brucelosis_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE cc_brucelosis 
                    SET cc_brucelosis_vacuna = :vacuna, 
                        cc_brucelosis_dosis = :dosis, 
                        cc_brucelosis_costo = :costo, 
                        cc_brucelosis_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM cc_brucelosis WHERE id = :id";
