...
try {
    ...
    if (mysqli_num_rows($result) > 0) {
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            $startDate = new DateTime($row['ch_concentrado_fecha_inicio']);
            $endDate = new DateTime($row['ch_concentrado_fecha_fin']);
            ...
            $totalExpense = (float)$row['ch_concentrado_racion'] * (float)$row['ch_concentrado_costo'] * $totalDays;
            ...
            while ($currentDate <= $endDate) {
                ...
                $monthlyData[$monthKey]['total_quantity'] += (float)$row['ch_concentrado_racion'];
                $monthlyData[$monthKey]['total_cost_sum'] += (float)$row['ch_concentrado_costo'];
