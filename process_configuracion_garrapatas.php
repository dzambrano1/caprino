...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO cc_garrapatas (cc_garrapatas_vacuna, cc_garrapatas_dosis, cc_garrapatas_costo, cc_garrapatas_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE cc_garrapatas 
                    SET cc_garrapatas_vacuna = :vacuna, 
                        cc_garrapatas_dosis = :dosis, 
                        cc_garrapatas_costo = :costo, 
                        cc_garrapatas_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM cc_garrapatas WHERE id = :id";
