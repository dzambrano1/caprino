...
<title>Caprino Configuracion Melaza</title>
<!-- Link to the Favicon -->
...
<!-- Plan de Alimentación con Melaza -->
<div class="container mt-4 mb-4">
    <div class="card feeding-plan-card">
        <div class="card-header feeding-plan-header">
            <h5 class="mb-0">🐐 Plan de Alimentación con Melaza – Caprinos en Venezuela</h5>
        </div>
        <div class="card-body">
                ...
                <table class="table feeding-plan-table">
                    <thead>
                        <tr>
                            ...
                            <th>Ración Diaria (kg / L)</th>
                            <th>% Proteína Estimada</th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>Melaza líquida Proagro / Melaza Caña Real</td>
                            <td>0.05–0.1 L diluida en agua</td>
                            <td>4–6% (energía, no proteína)</td>
                            <td>6–10</td>
                            <td>Introducir como fuente energética. Diluir 1:10 en agua. Estimula apetito y microbiota.</td>
                        </tr>
                        <tr>
                            <td>Post-destete (60–120 días)</td>
                            <td>Melaza Agropecuaria Lara / Melaza Caña Dulce</td>
                            <td>0.1–0.2 L/día</td>
                            <td>4–6%</td>
                            <td>12–18</td>
                            <td>Mezclar con concentrado o agua. Mejora palatabilidad y reservas de glucógeno.</td>
                        </tr>
                        <tr>
                            ...
                            <td>4–6%</td>
                            <td>20–30</td>
                            <td>Aporta energía rápida. Ideal en épocas secas o baja calidad forrajera.</td>
                        </tr>
                        <tr>
                            <td>Engorde / Finalización</td>
                            <td>Melaza Caña Dulce + Caprimix® 14</td>
                            <td>0.3–0.5 L/día</td>
                            <td>12–14% (mezcla)</td>
                            <td>35–45</td>
                            <td>Mezclar con concentrado. Mejora conversión y sabor. Dividir en 2 tomas si es posible.</td>
                        </tr>
                        <tr>
                            <td>Hembras Gestantes</td>
                            <td>Melaza Caña Real + Caprimix® Gestación</td>
                            <td>0.2–0.4 L/día</td>
                            <td>10–12% (mezcla)</td>
                            <td>Variable</td>
                            <td>Aumentar energía en último tercio. Vigilar condición corporal y evitar sobrepeso.</td>
                        </tr>
                        <tr>
                            <td>Hembras Lactantes</td>
                            <td>Melaza líquida Proagro + Caprimix® Lactancia</td>
                            <td>0.4–0.6 L/día</td>
                            <td>12–14% (mezcla)</td>
                            <td>Variable</td>
                            <td>Alta demanda energética. Dividir ración. Suplementar con calcio y fósforo.</td>
                        </tr>
                        <tr>
                            <td>Machos Reproductores</td>
                            <td>Melaza Agropecuaria Lara + Caprimix® Adultos</td>
                            <td>0.3–0.5 L/día</td>
                            <td>10–12% (mezcla)</td>
                            <td>50–70</td>
                            <td>Mantener condición corporal. Evitar exceso de energía en animales inactivos.</td>
                        </tr>
                    </tbody>
                </table>
            </div>
            <div class="strategic-observations">
                ...
                <ul>
                    <li><strong>Dilución Recomendada:</strong> 1 parte de melaza por 5–10 partes de agua para facilitar consumo y digestión.</li>
                    <li><strong>No sustituye proteína:</strong> La melaza es fuente energética, no proteica. Siempre complementar con concentrado o forraje.</li>
                    <li><strong>Trazabilidad:</strong> Registrar lote, fecha, volumen, mezcla y respuesta animal en tu sistema digital.</li>
                    <li><strong>Costo Estimado:</strong> USD $0.20–0.40/L según proveedor y volumen.</li>
                    <li><strong>Micotoxinas y fermentación:</strong> Almacenar en lugar fresco. Evitar fermentación en mezcla con forraje húmedo.</li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="newEntryModal" tabindex="-1" aria-labelledby="newEntryModalLabel">
  ...
  <!-- DataTable for cc_melaza records -->
...
<div class="container table-section" style="display: block;">
      <div class="table-responsive">
          <table id="melazaTable" class="table table-striped table-bordered">
              ...
              <tbody>
                  <?php
                      $melazaQuery = "SELECT * FROM cc_melaza";
                      ...
                      if (empty($melazasData)) {
                          ...
                          foreach ($melazasData as $row) {
                              ...
                              echo '        <button class="btn btn-warning btn-sm edit-melaza" 
                                              ...
                                              data-melaza="' . htmlspecialchars($row['cc_melaza_nombre'] ?? '') . '" 
                                              data-etapa="' . htmlspecialchars($row['cc_melaza_etapa'] ?? '') . '" 
                                              data-racion="' . htmlspecialchars($row['cc_melaza_racion'] ?? '') . '" 
                                              data-costo="' . htmlspecialchars($row['cc_melaza_costo'] ?? '') . '" 
                                              data-vigencia="' . htmlspecialchars($row['cc_melaza_vigencia'] ?? '') . '"
                              ...
                              // Column 1: Vacuna
                              echo "<td>" . htmlspecialchars($row['cc_melaza_nombre'] ?? '') . "</td>";
                              // Columna 2: Etapa
                              echo "<td>" . htmlspecialchars($row['cc_melaza_etapa'] ?? '') . "</td>";
                              
                              // Column 3: Dosis
                              echo "<td>" . htmlspecialchars($row['cc_melaza_racion'] ?? 'N/A') . "</td>";
                              
                              // Column 4: Costo
                              echo "<td>" . htmlspecialchars($row['cc_melaza_costo'] ?? 'N/A') . "</td>";
                              
                              // Column 5: Vigencia
                              echo "<td>" . htmlspecialchars($row['cc_melaza_vigencia'] ?? 'N/A') . "</td>";
...
<!-- Initialize DataTable for ec melaza -->
<script>
                        ...
                        <form id="editMelazaForm">
                            ...
                            <div class="mb-4">
                                ...
                                <select class="form-select" id="edit_melaza" name="melaza" required>
                                    ...
                                    $sql_names = "SELECT DISTINCT cc_melaza_nombre FROM cc_melaza ORDER BY cc_melaza_nombre ASC";
                                    $stmt_names = $conn->prepare($sql_names);
                                    $stmt_names->execute();
                                    $names = $stmt_names->fetchAll(PDO::FETCH_ASSOC);
                                    foreach ($names as $name_row) {
                                        echo '<option value="' . htmlspecialchars($name_row['cc_melaza_nombre']) . '">' . htmlspecialchars($name_row['cc_melaza_nombre']) . '</option>';
                                    }
                                    ?>
                                </select>
                            </div>
