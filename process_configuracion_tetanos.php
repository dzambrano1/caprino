...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO cc_tetanos (cc_tetanos_vacuna, cc_tetanos_dosis, cc_tetanos_costo, cc_tetanos_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE cc_tetanos 
                    SET cc_tetanos_vacuna = :vacuna, 
                        cc_tetanos_dosis = :dosis, 
                        cc_tetanos_costo = :costo, 
                        cc_tetanos_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM cc_tetanos WHERE id = :id";
