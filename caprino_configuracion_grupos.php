...
<title>caprino Configuracion Grupos</title>
<!-- Link to the Favicon -->
...
<div class="container text-center">
  <h3  class="container mt-4 text-white" class="collapse" id="section-configuracion-grupos">
...
<div class="modal fade" id="newEntryModal" tabindex="-1" aria-labelledby="newEntryModalLabel">
  ...
  <!-- DataTable for cc_grupos records -->
...
<div class="container table-section" style="display: block;">
      <div class="table-responsive">
          <table id="gruposTable" class="table table-striped table-bordered">
              ...
              <tbody>
                  <?php
                      $gruposQuery = "SELECT * FROM cc_grupos";
                      ...
                      if (empty($gruposData)) {
                          ...
                          foreach ($gruposData as $row) {
                              ...
                              echo '        <button class="btn btn-danger btn-sm delete-grupos" 
                                              data-id="' . htmlspecialchars($row['id'] ?? '') . '"
                                              data-grupos="' . htmlspecialchars($row['cc_grupos_nombre'] ?? '') . '"
                              ...
                              // Column 1: Grupos
                              echo "<td>" . htmlspecialchars($row['cc_grupos_nombre'] ?? '') . "</td>";
...
<!-- Initialize DataTable for caprino Grupos -->
<script>
                                ...
                                <div class="input-group">
                                    <span class="input-group-text">
                                        ...
                                        <select class="form-select" id="edit_grupos" name="grupos" required>
                                            ...
                                            $sql_names = "SELECT DISTINCT cc_grupos_nombre FROM cc_grupos ORDER BY cc_grupos_nombre ASC";
                                            $stmt_names = $conn->prepare($sql_names);
                                            $stmt_names->execute();
                                            $names = $stmt_names->fetchAll(PDO::FETCH_ASSOC);
                                            foreach ($names as $name_row) {
                                                echo '<option value="' . htmlspecialchars($name_row['cc_grupos_nombre']) . '">' . htmlspecialchars($name_row['cc_grupos_nombre']) . '</option>';
                                            }
                                            ?>
                                        </select>
                                    </span>                                    
