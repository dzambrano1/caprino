...
try {
    ...
    $sql_counts = "
        SELECT
            ...
            COUNT(DISTINCT a.ch_clostridiosis_tagid) AS vaccinated_animals
        FROM caprino v
        LEFT JOIN ch_clostridiosis a ON v.tagid = a.ch_clostridiosis_tagid
    ...
    $sql_list = "
        ...
        LEFT JOIN ch_clostridiosis a ON v.tagid = a.ch_clostridiosis_tagid
        WHERE v.grupo IS NOT NULL AND v.grupo != ''
          AND a.ch_clostridiosis_tagid IS NULL
