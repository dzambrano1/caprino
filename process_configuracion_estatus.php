...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO cc_estatus (cc_estatus_nombre) VALUES (:estatus)";
        ...
        case 'update':
            ...
            $sql = "UPDATE cc_estatus SET cc_estatus_nombre = :estatus WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM cc_estatus WHERE id = :id";
