...
<title>Caprino Configuracion</title>
<!-- Link to the Favicon -->
    ...
    <div class="container-fluid">
        <div class="row w-100">
            <div class="col-12 d-flex justify-content-center align-items-center">
                ...
                <i class="fas fa-cog me-2"></i>CONFIGURACION<span class="ms-2"><i class="fas fa-sliders-h"></i></span>
                </h1>
            </div>
        </div>
    </div>
...
<div class="container scroll-icons-container">
    ...
    <div class="container  salud-container" data-category="CONFIGURACION SALUD">
        <div class="icon-button-container">
            <button onclick="window.location.href='./caprino_configuracion_clostridiosis.php'" class="icon-button">
                <img src="./images/clostridiosis.png" alt="Inicio" class="nav-icon">
            </button>
            <span class="button-label">CLOSTRIDIOSIS</span>
        </div>

        <div class="icon-button-container">
            <button onclick="window.location.href='./caprino_configuracion_brucelosis.php'" class="icon-button">
                <img src="./images/cabra-brucelosis.png" alt="Inicio" class="nav-icon">
            </button>
            <span class="button-label">BRUCELOSIS</span>
        </div>

        <div class="icon-button-container">
            <button onclick="window.location.href='./caprino_configuracion_tetanos.php'" class="icon-button">
                <img src="./images/tetanos.png" alt="Inicio" class="nav-icon">
            </button>
            <span class="button-label">TETANOS</span>
        </div>

        <div class="icon-button-container">
            <button onclick="window.location.href='./caprino_configuracion_rabia.php'" class="icon-button">
                <img src="./images/rabia.png" alt="Inicio" class="nav-icon">
            </button>
            <span class="button-label">RABIA</span>
        </div>

        <div class="icon-button-container">
            <button onclick="window.location.href='./caprino_configuracion_garrapatas.php'" class="icon-button">
                <img src="./images/garrapatas.png" alt="Inicio" class="nav-icon">
            </button>
            <span class="button-label">GARRAPATAS</span>
        </div>

        <div class="icon-button-container">
            <button onclick="window.location.href='./caprino_configuracion_parasitos.php'" class="icon-button">
    ...
    <div class="container  alimentacion-container" data-category="CONFIGURACION ALIMENTACION">
        <div class="icon-button-container">
            <button onclick="window.location.href='./caprino_configuracion_concentrado.php'" class="icon-button">
        ...
        <div class="icon-button-container">
            <button onclick="window.location.href='./caprino_configuracion_melaza.php'" class="icon-button">
        ...
        <div class="icon-button-container">
            <button onclick="window.location.href='./caprino_configuracion_sal.php'" class="icon-button">
    ...
    <div class="container  poblacion-container" data-category="CONFIGURACION POBLACION">
        <div class="icon-button-container">
            <button onclick="window.location.href='./caprino_configuracion_razas.php'" class="icon-button">
                <img src="./images/raza.png" alt="Inicio" class="nav-icon">
            </button>
            <span class="button-label">RAZAS</span>
        </div>
        <div class="icon-button-container">
            <button onclick="window.location.href='./caprino_configuracion_etapas.php'" class="icon-button">
                <img src="./images/etapas.png" alt="Inicio" class="nav-icon">
            </button>
            <span class="button-label">ETAPAS</span>
        </div>
        <div class="icon-button-container">
            <button onclick="window.location.href='./caprino_configuracion_grupos.php'" class="icon-button">
        ...
        <div class="icon-button-container">
            <button onclick="window.location.href='./caprino_configuracion_estatus.php'" class="icon-button">
