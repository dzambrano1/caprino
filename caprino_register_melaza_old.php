                  ...
                  try {
                      // Query to get all Animals and ALL their melaza records (if any)
                        $melazaQuery = "
                            ...
                            FROM
                                caprino b
                            LEFT JOIN
                                ch_melaza c ON b.tagid = c.ch_melaza_tagid -- Join ALL matching melaza records
                            ORDER BY
                      ...
                      if (empty($melazaData)) {
                          ...
                          foreach ($melazaData as $row) {
                              ...
                              $melazaFecha = $row['ch_melaza_fecha'] ?? null;
                              ...
                              if ($hasMelaza) {
                                  ...
                                  echo '        <button class="btn btn-warning btn-sm edit-melaza" 
                                                  ...
                                                  data-etapa="'.htmlspecialchars($row['ch_melaza_etapa'] ?? '').'" 
                              ...
                              echo "<td>" . ($hasMelaza ? htmlspecialchars($row['ch_melaza_etapa'] ?? '') : 'N/A') . "</td>";
