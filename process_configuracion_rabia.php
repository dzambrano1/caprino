...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO cc_rabia (cc_rabia_vacuna, cc_rabia_dosis, cc_rabia_costo, cc_rabia_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE cc_rabia 
                    SET cc_rabia_vacuna = :vacuna, 
                        cc_rabia_dosis = :dosis, 
                        cc_rabia_costo = :costo, 
                        cc_rabia_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM cc_rabia WHERE id = :id";
