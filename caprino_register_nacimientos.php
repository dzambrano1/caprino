...
<title>Caprino Register Nacimientos</title>
<!-- Link to the Favicon -->
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (createEntryForm) {
            ...
            createEntryForm.addEventListener('submit', function(event) {
                ...
                fetch('caprino_nacimientos_create.php', {
                    method: 'POST',
                    body: formData
                })
...
function saveUpdates() {
    ...
    $.ajax({
        url: 'caprino_nacimientos_update.php',
        type: 'POST',
        data: formData,
      ...
      <div class="table-responsive">
          <table id="nacimientoTable" class="table table-striped table-bordered">
              ...
              <tbody>
                  <?php
                  try {
                      // Query to get nacimiento data directly from caprino table
