...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO cc_parasitos (cc_parasitos_vacuna, cc_parasitos_dosis, cc_parasitos_costo, cc_parasitos_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE cc_parasitos 
                    SET cc_parasitos_vacuna = :vacuna, 
                        cc_parasitos_dosis = :dosis, 
                        cc_parasitos_costo = :costo, 
                        cc_parasitos_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM cc_parasitos WHERE id = :id";
