...
<title>Caprino Configuracion Garrapatas</title>
<!-- Link to the Favicon -->
...
<div class="container table-section" style="display: block;">
      <div class="table-responsive">
          <table id="garrapatasTable" class="table table-striped table-bordered">
              ...
              <tbody>
                  <?php
                      $garrapatasQuery = "SELECT * FROM cc_garrapatas";
                      ...
                      if (empty($garrapatassData)) {
                          ...
                          foreach ($garrapatassData as $row) {
                              ...
                              echo '        <button class="btn btn-warning btn-sm edit-garrapatas" 
                                              ...
                                              data-vacuna="' . htmlspecialchars($row['cc_garrapatas_vacuna'] ?? '') . '" 
                                              data-dosis="' . htmlspecialchars($row['cc_garrapatas_dosis'] ?? '') . '" 
                                              data-costo="' . htmlspecialchars($row['cc_garrapatas_costo'] ?? '') . '" 
                                              data-vigencia="' . htmlspecialchars($row['cc_garrapatas_vigencia'] ?? '') . '"
                              ...
                              // Column 1: Vacuna
                              echo "<td>" . htmlspecialchars($row['cc_garrapatas_vacuna'] ?? '') . "</td>";
                              
                              // Column 2: Dosis
                              echo "<td>" . htmlspecialchars($row['cc_garrapatas_dosis'] ?? 'N/A') . "</td>";
                              
                              // Column 3: Costo
                              echo "<td>" . htmlspecialchars($row['cc_garrapatas_costo'] ?? 'N/A') . "</td>";
                              
                              // Column 4: Vigencia
                              echo "<td>" . htmlspecialchars($row['cc_garrapatas_vigencia'] ?? 'N/A') . "</td>";
