...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            $checkQuery = "SELECT COUNT(*) as count FROM caprino WHERE tagid = ?";
            ...
            if ($result['count'] > 0) {
                ...
                $sql = "UPDATE caprino SET " . implode(", ", $set_clauses) . " WHERE tagid = :tagid";
                ...
                echo json_encode([
                    ...
                    "redirect" => "caprino_register_compras.php"
                ]);
            } else {
                ...
                $sql = "INSERT INTO caprino (" . implode(", ", $fields) . ") VALUES (" . implode(", ", $placeholders) . ")";
        ...
        case 'update':
            ...
            $sql = "UPDATE caprino SET " . implode(", ", $set_clauses) . " WHERE id = :id";
        ...
        case 'delete':
            ...
            $sql = "UPDATE caprino SET fecha_compra = NULL, peso_compra = NULL, precio_compra = NULL WHERE tagid = :tagid";
        ...
        case 'delete_nacimiento':
            ...
            $sql = "UPDATE caprino SET fecha_nacimiento = NULL, peso_nacimiento = NULL WHERE tagid = :tagid";
    ...
    error_log("Error in caprino_update.php: " . $e->getMessage());
